...
voice "voice/c-13-1.wav" #Mister Deeks (???)
...
voice "voice/c-13-2.wav" #Mister Deeks (???)
...
voice "voice/c-13-3.wav" #Mister Deeks (???)
dee "Class dismissed!"
...
voice "voice/c-13-23.wav" #Stacey (Ashe Thurman)
sta "He started shaking and spouting off something about a bug infestation."

show stacey evil
voice "voice/c-13-24.wav" #Stacey (Ashe Thurman)
sta "Very convenient he had a box of tissues by his computer, 'just in case'."

voice "voice/c-13-25.wav" #Yumi (Kathy Pfautsch)
yum "Damn, he really is normal."

show stacey smug
voice "voice/c-13-26.wav" #Stacey (Ashe Thurman)
sta "Shocking, I know."


show lucca h neutral flip with easeinright:
    align (0.65, 1.0)
voice "voice/c-13-27.wav" #Lucca (Victoria Wong)
luc "I h-hope I'm not interrupting anything..."

voice "voice/c-13-28.wav" #Yumi (Kathy Pfautsch)
yum "Oh, hey Lucca."

show stacey confused
voice "voice/c-13-29.wav" #Stacey (Ashe Thurman)
sta "Yumi, you know the cowgirl?"

voice "voice/c-13-30.wav" #Yumi (Kathy Pfautsch)
yum "We go way back, she's another demon, sort of."

show lucca h mad
voice "voice/c-13-31.wav" #Lucca (Victoria Wong)
luc "I'm right here, you know!"

voice "voice/c-13-32.wav" #Yumi (Kathy Pfautsch)
yum "Don't mind her, she's friendly."

show stacey sarcasticlook
voice "voice/c-13-33.wav" #Stacey (Ashe Thurman)
sta "Are you sure? I hear you're not supposed to trust demons in funny hats."

voice "voice/c-13-34.wav" #Yumi (Kathy Pfautsch)
yum "I was talking about you and your funny hat, actually."

show lucca h uwah
voice "voice/c-13-35.wav" #Lucca (Victoria Wong)
luc "I-I'll have you know this hat is fashionable and f-functional..."

show stacey therocklook
voice "voice/c-13-36.wav" #Stacey (Ashe Thurman)
sta "I bet there's a big ol' horn under there. Like a unicorn. Majestic and aerodynamic."

show lucca h doh
voice "voice/c-13-37.wav" #Lucca (Victoria Wong)
luc "W-what!? N-No!"

"Stacey takes a good, hard look at Lucca's hat, carefully weighing the possibilities."

voice "voice/c-13-38.wav" #Stacey (Ashe Thurman)
sta "..."

show lucca h nervouser
voice "voice/c-13-39.wav" #Lucca (Victoria Wong)
luc "I-It's rude to stare..."

show stacey smug
voice "voice/c-13-40.wav" #Stacey (Ashe Thurman)
sta "Okay, I believe you."

voice "voice/c-13-41.wav" #Yumi (Kathy Pfautsch)
yum "What."

show stacey grin
voice "voice/c-13-42.wav" #Stacey (Ashe Thurman)
sta "If she says there isn't a horn, there isn't one."

voice "voice/c-13-43.wav" #Yumi (Kathy Pfautsch)
yum "Anyway..."

show lucca h nervous
voice "voice/c-13-44.wav" #Lucca (Victoria Wong)
...
menu:
    "Go with Stacey":
        voice "voice/c-13-45.wav" #Yumi (Kathy Pfautsch)
        yum "Sorry Lucca, I already made plans. Can it wait?"

        voice "voice/c-13-46.wav" #Lucca (Victoria Wong)
        show lucca h sigh
        luc "...I-I guess..."
        jump staceyroute
    "Go with Lucca":
        voice "voice/c-13-47.wav" #Yumi (Kathy Pfautsch)
        yum "Oh crap. Stacey, I'm gonna hafta cancel."

        show stacey confused
        voice "voice/c-13-48.wav" #Stacey (Ashe Thurman)
        sta "Eh? But, you promised..."

        voice "voice/c-13-49.wav" #Yumi (Kathy Pfautsch)
        yum "I know, but this concerns a certain demon with an ego. I'm sorry!"

        show stacey sad
        voice "voice/c-13-50.wav" #Stacey (Ashe Thurman)
        sta "It's cool, I guess... Writing is a lonely task anyway."

        show stacey smug
        voice "voice/c-13-51.wav" #Stacey (Ashe Thurman)
        sta "Go, lay the demon!"

        voice "voice/c-13-52.wav" #Lucca (Victoria Wong)
        luc "Do you mean \"Slay\"?"

        show stacey grinclosed
        voice "voice/c-13-53.wav" #Stacey (Ashe Thurman)
        sta "Close enough."
        jump luccaroute
...
$ route = "stacey"
voice "voice/c-13-54.wav" #Yumi (Kathy Pfautsch)
yum "I would, but I promised Stacey."

show lucca h guilty
voice "voice/c-13-55.wav" #Lucca (Victoria Wong)
luc "Not the issue here, but okay."

show stacey eyebrow
voice "voice/c-13-56.wav" #Stacey (Ashe Thurman)
...
$ route = "lucca"
voice "voice/c-13-57.wav" #Yumi (Kathy Pfautsch)
yum "I'll talk to you later, Stacey."

show stacey smug
voice "voice/c-13-58.wav" #Stacey (Ashe Thurman)
sta "Take it easy, Yumi."

show lucca h nervoussmile
voice "voice/c-13-59.wav" #Lucca (Victoria Wong)
